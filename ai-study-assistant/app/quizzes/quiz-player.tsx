...
export default function QuizPlayer() {
  ...
  function next() {
    if (current === questions.length - 1) {
      const attempt: QuizAttempt = { id: Date.now().toString(), title: "Quick Quiz", score, total: questions.length, date: new Date().toLocaleString() };
